...
namespace ov_core {
    ...
    protected:
		...
		CPU_TIMER3_THREAD_CONTEXT hist_l = CPU_TIMER3_MAKE_THREAD_CONTEXT();
		CPU_TIMER3_THREAD_CONTEXT hist_r = CPU_TIMER3_MAKE_THREAD_CONTEXT();
		CPU_TIMER3_THREAD_CONTEXT pyramid_l = CPU_TIMER3_MAKE_THREAD_CONTEXT();
		CPU_TIMER3_THREAD_CONTEXT pyramid_r = CPU_TIMER3_MAKE_THREAD_CONTEXT();
		CPU_TIMER3_THREAD_CONTEXT matching_l = CPU_TIMER3_MAKE_THREAD_CONTEXT(); 
		CPU_TIMER3_THREAD_CONTEXT matching_r = CPU_TIMER3_MAKE_THREAD_CONTEXT();
    };
