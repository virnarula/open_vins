...
void UpdaterMSCKF::update(State *state, std::vector<Feature*>& feature_vec) {
	...
	total_msckf_triang_time += msckf_triang_time;
	total_msckf_create_sys_time += msckf_create_sys_time;
	total_msckf_compress_sys_time += msckf_compress_sys_time;
	total_msckf_update_state_time += msckf_update_state_time;
	total_msckf_total_time += msckf_total_time;
	...
	std::cout << "[AVERAGE-MSCKF-UP]: " << total_msckf_clean_time/total_calls << " seconds to clean" << std::endl;
	std::cout << "[AVERAGE-MSCKF-UP]: " << total_msckf_triang_time/total_calls << " seconds to triangulate" << std::endl;
	std::cout << "[AVERAGE-MSCKF-UP]: " << total_msckf_create_sys_time/total_calls << " seconds create system" << std::endl;
	std::cout << "[AVERAGE-MSCKF-UP]: " << total_msckf_compress_sys_time/total_calls << " seconds compress system" << std::endl;
	std::cout << "[AVERAGE-MSCKF-UP]: " << total_msckf_update_state_time/total_calls << " seconds update state" << std::endl;
	std::cout << "[AVERAGE-MSCKF-UP]: " << total_msckf_total_time/total_calls << " seconds total" << std::endl;
}
